...
public class Utils {
    ...
    public static final String PIZZA_2_DESCRIPTION = "Even a novice cook can master the art of perfect pizza with our step-by-step guide. This homemade pizza recipe features a simple pizza dough and toppings.";
    ...
    public static final String  PIZZA_4_TITLE = "Christmas tree pizza tart";
    public static final String PIZZA_4_DESCRIPTION = "Bring festive fun to dinnertime with our tree-shaped pizza made with shop-bought pastry. Choose your own toppings, such as pancetta, chopped chipolatas and pesto";
    ...
    public static final String  PIZZA_5_TITLE = "Homemade Turkish lahmacun";
    public static final String PIZZA_5_DESCRIPTION = "Sometimes called 'Turkish pizza', this crispy flatbread topped with spiced mincemeat is a popular street food across the Middle East";
    ...
    public static final String  PIZZA_6_TITLE = "Pepperoni pizza rolls";
    public static final String PIZZA_6_DESCRIPTION = "Rustle up these family-friendly pepperoni pizza rolls. You could speed things up if you like by using ready-made pizza dough and pizza sauce.";
    ...
    public static final String  PIZZA_7_TITLE = "Superhealthy pizza";
    public static final String PIZZA_7_DESCRIPTION = "The quantities for this vegetarian pizza are generous, so if you have any leftovers, pop a few cold slices into your lunchbox for the next day";
    ...
    public static final String  PIZZA_8_TITLE = "Frying pan pizza";
    public static final String PIZZA_8_DESCRIPTION = "Not good for you? Think again, this easy to make pizza is low fat and full of calcium";
    ...
    public static final String  PIZZA_9_TITLE = "Egg & rocket pizzas";
    public static final String PIZZA_9_DESCRIPTION = "Use seeded tortillas as pizza bases for a quick and healthy lunch - crack an egg in the centre and bake to boost protein intake";
